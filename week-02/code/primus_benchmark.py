...
def get_primus_benchmark_callback(output_dir: str = "./benchmark_results"):
    """
...
def add_benchmark_to_trainer(trainer, output_dir: str = "./benchmark_results"):
    """
...
trainer = Trainer(...)
add_benchmark_to_trainer(trainer, output_dir="./benchmark_results")
trainer.fit(model, datamodule)
...
Results will be saved to:
  ./benchmark_results/benchmark_rocm_TIMESTAMP.json
